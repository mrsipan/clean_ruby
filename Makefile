puppet: clean_ruby_22-2.2.0-1.src.rpm puppet-4.1.0.tar.gz facter-2.4.4.tar.gz hiera-2.0.0.tar.gz
	...
	sudo /opt/clean_ruby_22/bin/ruby facter-2.4.4/install.rb
	tar -xvzf hiera-2.0.0.tar.gz
	sudo /opt/clean_ruby_22/bin/ruby hiera-2.0.0/install.rb --configdir=/opt/puppet/etc
	tar -xvzf puppet-4.1.0.tar.gz
	sudo /opt/clean_ruby_22/bin/ruby puppet-4.1.0/install.rb --configdir=/opt/puppet/etc --codedir=/opt/puppet/code --vardir=/opt/puppet/var
